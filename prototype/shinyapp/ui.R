...
ui <- page_navbar(
  ...
  nav_menu(
              ...
              fluidRow(
                ...
                column(
                  ...
                  card(
                    ...
                    card_header(
                    class = "bg-dark", "American Community Survey(ACS)"
                    ),
                    card_body(
    ...
    nav_panel(title = "Meet the Teams",
              value = "Home",
              navset_card_tab(
                title = "Meet the Teams",
                nav_panel("VT DSPG",
                          layout_sidebar(sidebar = sidebar(includeMarkdown("markdown/meet_the_team/vtdspg.md")),
                          card(
                ...
                nav_panel("Fall '21",
                          layout_sidebar(sidebar = sidebar(includeMarkdown("markdown/meet_the_team/cmda.md")),
                          card(
